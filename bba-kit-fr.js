...
var T     = {"name": "Ton nom", "caps": "Majuscules", "check": "Vérifier", "download": "Télécharger", "hide": "Réduire", "ready": "Écris ton nom, puis « Vérifier » pour une correction tolérante, et « Télécharger » pour envoyer ton travail.", "right": "Correct.", "accOk": "Accent manquant ou en trop — pas de pénalité ici, mais corrige-le.", "accGram": "L'accent change le mot ou le temps : il faut l'écrire exactement.", "typo": "Faute de frappe tolérée — la terminaison est bonne.", "wrong": "Pas encore.", "blank": "Rien d'écrit.", "exact": "exact", "accSlip": "accents", "typoSlip": "frappe", "wrongN": "faux", "blankN": "vides", "nameFirst": "Fichier téléchargé — pense à écrire ton nom avant de l'envoyer.", "noName": "(sans nom)", "noKeyTitle": "Pas de corrigé sur cette page.", "noKey": "Le pavé d'accents et le téléchargement fonctionnent quand même : tes réponses seront enregistrées telles quelles pour ton professeur.", "noKeyCsv": "Cette page ne contient pas de corrigé exploitable — à corriger par le professeur.", "hStudent": "Élève", "hActivity": "Activité", "hLink": "Lien", "hDate": "Date", "hScore": "Score", "hBreak": "Détail", "hReview": "À revoir", "cItem": "Question", "cAnswer": "Ta réponse", "cExpected": "Attendu", "cVerdict": "Résultat", "cNote": "Commentaire", "codes": {"ok": "Correct", "accent": "Accepté (accent)", "typo": "Accepté (frappe)", "no": "Faux", "empty": "Vide"}};                      // interface strings
